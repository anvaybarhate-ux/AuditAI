    ...
    >
      ...
      {showContent && (
        ...
        >
            ...
            >
            <h1 className="text-foreground text-3xl sm:text-5xl font-semibold tracking-tight drop-shadow-lg">
                {title}
            </h1>
            ...
            >
                ...
                <div className="relative rounded-2xl p-[2px] shadow-lg bg-gradient-to-br from-white/10 via-white/5 to-black/20">
                    <textarea
                    value={prompt}
                    onChange={(e) => setPrompt(e.target.value)}
                    placeholder={animatedPlaceholder}
                    rows={5}
                    className="w-full h-32 sm:h-36 resize-none rounded-2xl bg-[rgba(15,15,20,0.55)] border border-foreground/10 text-foreground placeholder:text-foreground/40 outline-none focus:ring-2 focus:ring-[#1f3dbc]/40 focus:border-[#1f3dbc]/40 backdrop-blur-md px-4 py-4 pr-16"
                    />
                </div>
                <button
                    type="submit"
