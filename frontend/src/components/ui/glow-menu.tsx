...
interface MenuBarProps extends Omit<HTMLMotionProps<"nav">, "onDrag"> {
  items: MenuItem[]
  activeItem?: string
...
export const MenuBar = React.forwardRef<HTMLElement, MenuBarProps>(
  ({ className, items, activeItem, onItemClick, ...props }, ref) => {
    ...
    return (
      ...
      >
        <motion.div
          className={`absolute -inset-2 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-transparent ${
            isDarkTheme
